export default {
  ...
  content: [
    "components/**/*.{vue,js}", // these are the files that will be scanned for class names
    "layouts/**/*.{vue,js}", // these are the files that will be scanned for class names
    "pages/**/*.{vue,js}", // these are the files that will be scanned for class names
